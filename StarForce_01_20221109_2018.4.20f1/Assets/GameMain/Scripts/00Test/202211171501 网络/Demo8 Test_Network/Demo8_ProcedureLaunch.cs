...
public class Demo8_ProcedureLaunch : ProcedureBase {
	...
	protected override void OnEnter (ProcedureOwner procedureOwner) {
		...
		m_Channel = Network.CreateNetworkChannel ("testName",GameFramework.Network.ServiceType.Tcp, m_NetworkChannelHelper);
		m_Channel.Connect (IPAddress.Parse ("127.0.0.1"), 8098);// 连接服务器
	}
