...
public class Common
{
    ...
    public GameObject  Find_GameObject(string goName)
    {
      return  GameObject.Find(goName); //全局搜索，耗性能
    }

    /// <summary>搜索子树 </summary>
    public Transform Find_transform(Transform t, string path)
    {
    ...
    public static Text Canvas_Text_Get()
    {
        ...
        return canvas.transform.Find("Text").GetComponent<Text>();
    }
